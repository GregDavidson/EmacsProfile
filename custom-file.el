...
(custom-set-variables
 ...
 '(org-log-done 'time)
	'(package-selected-packages
		 '(evil-magit evil evil-org use-package workgroups2 typed-clojure-mode toc-org tldr sqlup-mode sql-indent smex scala-mode2 scala-mode rainbow-delimiters racer prolog project-mode php-mode perspective persp-mode perl6-mode paredit-everywhere ox-gfm org-tree-slide org-ref org-projectile org-page org-bullets org-autolist mysql-to-org multi-term markdown-mode magithub ido-ubiquitous idle-highlight-mode git-rebase-mode git-commit-mode ghci-completion flycheck-rust flycheck-haskell flycheck-clojure find-file-in-project enh-ruby-mode emacsql-sqlite emacsql-psql emacsql-mysql ecb-snapshot company-racer closure-lint-mode clojure-mode-extra-font-locking cljsbuild-mode cljdoc auto-complete))
