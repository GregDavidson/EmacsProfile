...
Much of the power of [[https://www.gnu.org/software/emacs][Emacs]] is do to its extraordinarily
customizability through settings and extentions.  Many of
the most powerful of the extensions, which are available
from Emacs Package Repositories are themselves highly
...
The files in this Repository are designed to make
...
In addition it is desired that the customizations in this
repository can be
